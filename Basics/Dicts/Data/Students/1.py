...
"""
Вивести імена і групи кожного студента у форматі
- <name> (<group_name>)
"""
for group_name in students:  # "C"
    students_of_group = students[group_name]
    for student in students_of_group:  # {'name': '...', ...}
        print(f"{student['name']} ({group_name})")
        # print(student['name'], '(', group_name, ')')
